...
class MBarrierGetOp(_ods_ir.OpView):
  ...
  @builtins.property
  def mbarrierPointer(self):
    return self.operation.results[0]

def mbarrier_get(mbarrier_pointer, barriers, mbar_id, *, loc=None, ip=None) -> _ods_ir.Value:
...
def tma_fence_descriptor(tensor_map_descriptor, *, loc=None, ip=None) -> _ods_ir.Operation:
