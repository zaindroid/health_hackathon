...
class AtomicBinOp(IntEnum):
    ...
    def __str__(self):
        ...
        if self is AtomicBinOp.usub_sat:
            return "usub_sat"
        if self is AtomicBinOp.fmaximum:
            return "fmaximum"
        if self is AtomicBinOp.fminimum:
            return "fminimum"
...
class GEPNoWrapFlags(IntFlag):
    ...
    def __str__(self):
        if len(self) > 1:
            return "|".join(map(str, self))
        if self is GEPNoWrapFlags.none:
            return "none"
        if self is GEPNoWrapFlags.inboundsFlag:
            return "inbounds_flag"
        if self is GEPNoWrapFlags.nusw:
            return "nusw"
        if self is GEPNoWrapFlags.nuw:
            return "nuw"
        if self is GEPNoWrapFlags.inbounds:
            return "inbounds"
        raise ValueError("Unknown GEPNoWrapFlags enum entry.")
...
class ProfileSummaryFormatKind(IntEnum):
    ...
    def __str__(self):
        if self is ProfileSummaryFormatKind.SampleProfile:
            return "SampleProfile"
        if self is ProfileSummaryFormatKind.InstrProf:
            return "InstrProf"
        if self is ProfileSummaryFormatKind.CSInstrProf:
            return "CSInstrProf"
        raise ValueError("Unknown ProfileSummaryFormatKind enum entry.")



@register_attribute_builder("LLVM_ProfileSummaryFormatKind")
...
class ModFlagBehavior(IntEnum):
    ...
    def __str__(self):
        if self is ModFlagBehavior.Error:
            return "error"
        if self is ModFlagBehavior.Warning:
            return "warning"
        if self is ModFlagBehavior.Require:
            return "require"
        if self is ModFlagBehavior.Override:
            return "override"
        if self is ModFlagBehavior.Append:
            return "append"
        if self is ModFlagBehavior.AppendUnique:
            return "append_unique"
        if self is ModFlagBehavior.Max:
            return "max"
        if self is ModFlagBehavior.Min:
            return "min"
        raise ValueError("Unknown ModFlagBehavior enum entry.")



@register_attribute_builder("ModFlagBehaviorAttr")
def _modflagbehaviorattr(x, context):
    return _ods_ir.IntegerAttr.get(_ods_ir.IntegerType.get_signless(64, context=context), int(x))
...
class UWTableKind(IntEnum):
    ...
    def __str__(self):
        if self is UWTableKind.None_:
            return "none"
        if self is UWTableKind.Sync:
            return "sync"
        if self is UWTableKind.Async:
            return "async"
        raise ValueError("Unknown UWTableKind enum entry.")



@register_attribute_builder("UWTableKindEnum")
def _uwtablekindenum(x, context):
    return _ods_ir.IntegerAttr.get(_ods_ir.IntegerType.get_signless(64, context=context), int(x))
