...
class GPUFuncOp(_ods_ir.OpView):
  ...
  def __init__(self, function_type, *, arg_attrs=None, res_attrs=None, workgroup_attrib_attrs=None, private_attrib_attrs=None, known_block_size=None, known_grid_size=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_606')) else
      _ods_ir.AttrBuilder.get('anonymous_606')(function_type, context=_ods_context))
...
class SubgroupMmaExtractThreadLocalOp(_ods_ir.OpView):
  ...
  def __init__(self, matrix, indices, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def subgroup_mma_extract_thread_local(matrix, indices, *, loc=None, ip=None) -> _ods_ir.Value:
  return SubgroupMmaExtractThreadLocalOp(matrix=matrix, indices=indices, loc=loc, ip=ip).result
...
def subgroup_mma_insert_thread_local(res, value, matrix, indices, *, loc=None, ip=None) -> _ods_ir.Value:
