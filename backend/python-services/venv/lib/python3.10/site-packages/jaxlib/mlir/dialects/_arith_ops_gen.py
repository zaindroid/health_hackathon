...
def scaling_extf(out, in_, scale, *, fastmath=None, loc=None, ip=None) -> _ods_ir.Value:
...
def scaling_truncf(out, in_, scale, *, roundingmode=None, fastmath=None, loc=None, ip=None) -> _ods_ir.Value:
