...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_PROFILERCONFIG'].fields_by_name['enable_input_output_latency']._options = None
  _globals['_PROFILERCONFIG'].fields_by_name['enable_input_output_latency']._serialized_options = b'\030\001'
  _globals['_PROFILERCONFIG'].fields_by_name['trace_log_duration_events']._options = None
  _globals['_PROFILERCONFIG'].fields_by_name['trace_log_duration_events']._serialized_options = b'\030\001'
  _globals['_CALCULATORGRAPHCONFIG_NODE'].fields_by_name['profiler_config']._options = None
  _globals['_CALCULATORGRAPHCONFIG_NODE'].fields_by_name['profiler_config']._serialized_options = b'\030\001'
  _globals['_CALCULATORGRAPHCONFIG'].fields_by_name['packet_generator']._options = None
  _globals['_CALCULATORGRAPHCONFIG'].fields_by_name['packet_generator']._serialized_options = b'\030\001'
